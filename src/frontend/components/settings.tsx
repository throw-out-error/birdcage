            ...
            <div className="settings">
                <div className="setting">
                    <Input
                        ...
                        onSubmit={this.onSetPassword.bind(this)}
                    />
                    <button
                        type="button"
                ...
                <div className="setting">
                    <Input
                        ...
                        onChanged={(val) => this.setState({ color: val })}
                        onSubmit={() =>
                ...
                <div className="setting">
                    <Input
                        ...
                        value={this.props.bgtag}
                        onChanged={(val) => this.setState({ bgtag: val })}
                        onSubmit={() => this.props.onChangeBg(this.state.bgtag)}
                    />
                    <button
                        type="button"
                        onClick={() => this.props.onChangeBg(this.state.bgtag)}
                        className="btn"
                    >
                        <i className="fa fa-save"></i>
                    </button>
